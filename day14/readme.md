...
# how to run
## install local flask demo
- cd flaskdemo
- pip install -r requirements.txt
- python flaskdemo/__init__.py
- view http://127.0.0.1:5000/static/swagger-ui/index.html on chrome browser
- cd src/robot_yaml
- python run.py
- Open test-log.html on chrome browser
...
==============================================================================
Output:  \src\robot_yaml\outputs\test-output.xml
...
4 tests total, 4 passed, 0 failed
==============================================================================
Output:  \src\robot_yaml\outputs\test.xml
```
