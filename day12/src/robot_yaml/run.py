...
def init_testcases(suite, cases, method, uri):
    ...
    for index, tcase in enumerate(cases):
        ...
        # data_payloads = ptn.get_case_data(tcase)
        # json_payloads = ptn.get_case_json(tcase)
        # params_payloads = ptn.get_case_params(tcase)
        ...
        send_request(test, method, uri, tcase, session_name, assign_name)
